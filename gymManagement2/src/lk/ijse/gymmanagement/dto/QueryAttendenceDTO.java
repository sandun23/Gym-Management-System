 ...
 */
public class QueryAttendenceDTO {
    private String AID;
    ...
    public QueryAttendenceDTO() {
    }

    public QueryAttendenceDTO(String AID, String A_Date, String In_Time, String Out_Time, String Membership_No, String fName) {
        this.AID = AID;
        this.A_Date = A_Date;
